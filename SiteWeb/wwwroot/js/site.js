...
class LayoutView {
    ...
    static MajPanier() {
        //MAJ du panier
        $.ajax({
            url: "../GestionStockAPI/getnbProduitPanier",
            type: "POST",
            dataType: "json",
            success: function (data) {
                if (data.success) {
                    $('#nbPrdPanier').html('<p>' + data.data + '</p>')
                    // LayoutView.afficherPanierContent();
    ...
    $.ajax({
        ...
        success: function (data) {
            if (data.success) {
                ...
                strContenuModal += "<button type='button' class='btn btn-primary' onclick=ajouterPanier(" + prd.id + ")>Ajouter au panier</button>"
                strContenuModal += "</div>"
                ...
                strContenuModal += "<button type='button' class='btn btn-danger' onclick=closeModalProduit() data-dismiss='modal'>Quitter</button>"
                strContenuModal += "</div>"
...
function ajouterPanier(id) {
    var qte = $('#quantiteCmd').val();
    $.ajax({
        url: "../GestionStockAPI/createLignePanier",
